    ...
    <Wrapper ref={ref} {...bind}>
      ...
      >
        ...
        <img
          ...
          src="/images/flutter/background3.svg"
          style={{
            transform: `
              translateX(${centerX / 5}px) 
              translateY(${centerY / 5}px)
        ...
        <img
          ...
          src="/images/flutter/background2.svg"
          style={{
            transform: `
              translateX(${centerX / 6}px) 
              translateY(${centerY / 6}px)
        ...
        <img
          ...
          src="/images/flutter/background1.svg"
          style={{
            transform: `
